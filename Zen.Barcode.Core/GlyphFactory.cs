...
namespace Zen.Barcode
{
	...
	public abstract class GlyphFactory
	{
		...
		/// <returns>An <see cref="T:Int32"/> representing the character 
		...
		/// <summary>
		/// Gets the <see cref="T:BarGlyph"/> at the specified ordinal
		/// index.
		/// </summary>
		/// <param name="index">The glyph ordinal index.</param>
		/// <returns>A <see cref="T:BarGlyph"/> glyph object.</returns>
		...
		/// <summary>
		/// Gets the <see cref="T:BarGlyph"/> that corresponds to the
		/// specified character.
		/// </summary>
		/// <param name="character">The character to be located.</param>
		/// <returns>A <see cref="T:BarGlyph"/> glyph object.</returns>
		...
		/// </summary>
		/// <param name="glyph">The <see cref="T:BarGlyph"/> to be located.</param>
		/// <returns>The ordinal index of the glyph or -1 if not found.</returns>
		...
		/// <summary>
		/// Gets the collection of <see cref="T:BarGlyph"/> that represent
		/// the raw bar-code glyphs for the given bar-code symbology.
		/// </summary>
		...
		/// <summary>
		/// Gets the collection of <see cref="T:CompositeGlyph"/> that represent
		/// the composite bar-code glyphs for the given bar-code symbology.
		/// </summary>
		/// <returns>The full collection of <see cref="T:CompositeGlyph"/>
		/// objects associated with this symbology.</returns>
