...
namespace Zen.Barcode
{
		...
		where TChecksum : Checksum
	{
		...
		/// </summary>
		/// <param name="glyph">A <see cref="T:Glyph"/> to be queried.</param>
		...
		/// If the glyph implements <see cref="T:IVaryLengthGlyph"/> then the
		...
		/// </summary>
		/// <param name="barcode">
		/// Collection of <see cref="T:Glyph"/> objects to be rendered.
		/// </param>
		...
		/// </summary>
		/// <param name="barcode">A collection of <see cref="T:Glyph"/> objects representing the
		/// barcode to be rendered.</param>
		/// <param name="dc">A <see cref="T:Graphics"/> representing the draw context.</param>
			...
			int barMinWidth, int barMaxWidth)
		{
			...
			foreach (BarGlyph glyph in barcode)
			{
				RenderBar (glyph, dc, bounds, ref barOffset, barMinHeight,
					barMinWidth, barMaxWidth);
		...
		/// </summary>
		/// <param name="glyph">A <see cref="T:Glyph"/> object to be rendered.</param>
		/// <param name="dc">A <see cref="T:Graphics"/> representing the draw context.</param>
		/// <param name="bounds">The bounding rectangle.</param>
		...
		/// </exception>
		protected virtual void RenderBar (BarGlyph glyph, Graphics dc,
			...
			int barMinWidth, int barMaxWidth)
		{
			...
			else
			{
				...
				{
					int bitMask = (1 << bitIndex);
					if ((glyph.BitEncoding & bitMask) != 0)
					{
						dc.FillRectangle (Brushes.Black, barOffset, bounds.Top,
							barMinWidth, height);
					}
